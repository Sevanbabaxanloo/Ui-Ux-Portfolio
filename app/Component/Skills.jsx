...
const styles = {
  ...
  SkillsChildrenContainer:
    "flex flex-row flex-wrap justify-between gap-y-[24px] max-mb:justify-center max-mb:gap-x-[28px] max-md:justify-center container-skill max-md:flex-col max-md:items-center ",
  SkillsChildrenDiv:
