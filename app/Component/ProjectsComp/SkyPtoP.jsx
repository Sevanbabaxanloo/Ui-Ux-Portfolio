...
const styles = {
  ProjectListGridContainerMain:
    "w-[100vw] px-[102px] flex flex-col items-center max-mb:px-[33px] max-xs:px-[14px] mt-[60px] max-md:mt-[50px]",
  ProjectListGridContainerDiscriptionDiv:
    "flex flex-col items-center gap-[24px] w-[77.78vw] max-mb:w-auto max-sb:items-center",
  ...
  ProjectListGridChild1:
    "bg-[#1A1A1A] w-full rounded-[13.8px] row-span-2 w-[18.47] h-[572px] px-[23px] pt-[23px]",
  ...
  ScopeMainDiv: "px-[33px] flex flex-col items-center max-mb:px-[33px] max-xs:px-[14px]",
  ScopeMainContainer:
    "w-[1234px] max-xxl:w-full max-xxl:flex max-xxl:flex-col max-xxl:items-center",
  ScopeMainContainerFirstDiv: "mb-[100px]",
  ScopeMainContainerSecondDivContainer:
    "flex flex-col gap-[80px] max-ss:gap-[50px] max-md:gap-[40px]",
  ScopeMainContainerCardDiv:
    "flex justify-end gap-[40px] max-xxl:flex-wrap max-xxl:justify-center max-md:gap-[5vw]",
  ScopeMainCardDiv:
    "w-[267px] h-[250px] bg-[#1a1a1a] rounded-[30px] max-md:h-auto max-ss:w-full",
  ScopeMainCardImgOne:
  ...
  ProjectListChartTitle: "mt-[60px] font-[700] text-center text-[22px] text-[#6e2feb] leading-[26px]",
    ...
    <div className="project-detail relative ">
      ...
      <div>
        <div className="relative w-full flex flex-col items-center">
          <div className="relative w-full text-center z-10 pt-14 px-6 pb-0 mb-[-16%] max-md:mb-0 max-sm:pt-9 px-4">
            <div className="pb-8 max-md:mx-auto max-md:rounded-tl-[14px] max-md:rounded-tr-[14px] max-md:border-b-0 max-md:w-[88%] max-sm:p-[22px] max-sm:w-[92%] max-sm:max-w-[92%]">
              <div className="flex flex-col gap-[12px]">
                ...
                <h1 className="text-[#ffffff] font-[600] text-[36px] leading-[43px] text-center max-xs:text-[32px] max-mb:text-[32px]">
                  SkyPtoP
                </h1>
              </div>
              <div className="flex gap-[9px] justify-center max-ss:flex-wrap mt-[32px]">
                {["Deliver/track/send", "App", "Delivery", "View"].map((label) => (
                  <div key={label}>
                    <p className="h-[33px] py-[6px] px-[16px] bg-[#0f0f0f] text-[#FEFFFF] text-[14px] font-[400] text-center rounded-[69px]">
                      {label}
                    </p>
                  </div>
                ))}
          ...
          <div className="relative w-full ">
            <div className="relative mx-auto w-full aspect-[4/3] max-md:rounded-none max-md:w-full max-md:aspect-[4/2.5] max-sm:w-[92%] max-sm:aspect-[4/2.2]">
              <img
                src="/Assets/Skyptop/iPhone14Problack.png"
                alt="iPhone on dark rocky surface"
                className="main-photo"
              />
            </div>
          </div>
          <div className="relative z-10 flex flex-col items-center w-full mt-[-16%] max-md:mt-0 max-md:pb-12 max-sm:pb-10">
            <div className="relative z-10 text-center px-10 py-7 mb-9 w-[720px] max-w-[88%] max-md:rounded-bl-[14px] max-md:rounded-br-[14px] max-md:border-t-0 mb-7 max-md:w-[88%] max-md:max-w-[88%] max-sm:p-[22px] max-sm:w-[92%] max-sm:max-w-[92%]">
              <h2 className="text-[#FEFFFF] text-[36px] font-[600] leading-[43px] text-center max-xxl:text-[2.5vw] max-md:text-[32px] mb-6">About SkyPtoP</h2>
              <p className="text-[#DCDCDC] text-[20px] font-[400] leading-[24px] text-center max-xxl:text-[18px] max-md:text-[16px] mb-4">
                SkyPtoP provides a convenient online service for finding fellow-travellers
                who can deliver your parcel on their way. We have created a functional
                platform that allows you to estimate the cost of delivery, choose a
                suitable fellow-traveller and arrange delivery online.
              </p>
              <p className="text-[#DCDCDC] text-[20px] font-[400] leading-[24px] text-center max-xxl:text-[18px] max-md:text-[16px] mb-4">
                We strive to make the process of sending parcels as simple and convenient
                as possible for everyone. Our service allows you to save time and money,
                and also contributes to environmental safety...
              </p>
            </div>
          </div>
        </div>
      ...
      <div className={styles.ProjectListGridContainerMain}>
        ...
        <div className={styles.ProjectListGridContainer}>
          ...
          <div className={styles.ProjectListGridChild4}>
            <div>
              <img
                src="/Assets/futurest-img/a-futurest.png"
                alt="logo"
            ...
            <div className={styles.ScopeMainContainerCardDiv}>
              <div className={styles.ScopeMainCardDiv}>
                <div className="relative">
                  <img
                    src="/Assets/futurest-img/Rocket.png"
                    alt="rocket"
              ...
              <div className={styles.ScopeMainCardDiv}>
                <div className="relative">
                  <img
                    src="/Assets/futurest-img/dart.png"
                    alt="rocket"
              ...
              <div className={styles.ScopeMainCardDiv}>
                <div className="relative">
                  <img
                    src="/Assets/futurest-img/paint.png"
                    alt="rocket"
              ...
              <div className={styles.ScopeMainCardDiv}>
                <div className="relative">
                  <img
                    src="/Assets/futurest-img/phone.png"
                    alt="rocket"
              ...
              <div className={styles.ScopeMainCardMainDiv}>
                <div className={styles.ScopeMainCardDivLastCart}>
                  <div className={styles.ScopeMainLastCartImg}>
                    <img src="/Assets/futurest-img/figma.png" alt="rocket" className="w-[64px] " />
                  </div>
      ...
      <div className="mt-[120px]">
        <div className="flex flex-col items-center">
          ...
          <div className="w-[877PX] flex flex-col flex-wrap gap-[100px] items-center max-lg:w-[100vw] max-md:text-center">
            <div className="flex gap-[39px] max-ss:flex-col max-ss:w-full msx-ss:flex max-ss:flex-col max-ss:items-center">
              <div className="w-[434px] max-lg:w-[42vw] flex flex-col items-center max-ss:px-[33px] max-ss:w-full max-xs:px-[14px]">
                <img src="/Assets/Skyptop/Empathy.svg" alt="" />
              ...
              <div className="w-[404px] max-lg:w-[39vw] flex flex-col items-center max-ss:px-[33px] max-ss:w-full max-xs:px-[14px]">
                <img src="/Assets/Skyptop/Define.png" alt="" />
                <div className="flex flex-col gap-[16px] mt-[16px]">
                  <h2 className="text-[24px] text-[#ffffff] font-[700] leading-[36px] tracking-[2px] max-ss:text-[20px]">
                    Define
                  </h2>
            ...
            <div className="flex gap-[39px] max-ss:flex-col">
              <div className="w-[434px] max-lg:w-[42vw] flex flex-col items-center max-ss:px-[33px] max-ss:w-full max-xs:px-[14px]">
                <img src="/Assets/Skyptop/Ideate.png" alt="" />
                <div className="flex flex-col gap-[16px] mt-[16px]">
                  <h2 className="text-[24px] text-[#ffffff] font-[700] leading-[36px] tracking-[2px] max-ss:text-[20px]">
                    Ideate
                  </h2>
              ...
              <div className="w-[404px] max-lg:w-[39vw] flex flex-col items-center max-ss:px-[33px] max-ss:w-full max-xs:px-[14px]">
                <img src="/Assets/Skyptop/Prototype.png" alt="" />
                <div className="flex flex-col gap-[16px] mt-[16px]">
                  <h2 className="text-[24px] text-[#ffffff] font-[700] leading-[36px] tracking-[2px] max-ss:text-[20px]">
                    Prototype
                  </h2>
            ...
            <div className="w-[709px] max-lg:w-[69vw] flex flex-col items-center max-ss:px-[33px] max-ss:w-full max-xs:px-[14px]">
              <img src="/Assets/Skyptop/Test.png" alt="" />
              <div className="flex flex-col gap-[16px] mt-[16px]">
                <h2 className="text-[24px] text-[#ffffff] font-[700] leading-[36px] tracking-[2px] max-ss:text-[20px]">
                  Test
                </h2>
          ...
          <div>
            <div className={styles.UserPersonContainerDiv}>
              <div className={styles.UserPersonContainerDivTwo}>
                <div>
                  <img
                    src="/Assets/futurest-img/alex.png"
                    alt="alex"
              ...
              <div className={styles.UserPersonCartMainDiv}>
                <div className={styles.UserPersonCartMainSecondDiv}>
                  <div className={styles.UserPersonCartFirstCart}>
                    <img
                      src="/Assets/futurest-img/star.png"
                      alt="star"
                ...
                <div className={styles.UserPersonCartSecondCartMainDiv}>
                  <div className={styles.UserPersonCartSecondCartMainInerDiv}>
                    <div className={styles.UserPersonCartSecondCart}>
                      <img
                        src="/Assets/futurest-img/rocketship.png"
                        alt="rocketship"
          ...
          <div>
            <div className={styles.UserPersonContainerDiv}>
              <div className={styles.UserPersonContainerDivTwo}>
                <div>
                  <img
                    src="/Assets/futurest-img/kseniya.png"
                    alt="Kseniya"
                    className={styles.UserPersonContainerDivTwoImg}
                  />
                </div>
      ...
      <div className="mt-[120px] px-[70px] mb-[100px] max-ss:px-[33px] max-ss:w-full max-xs:px-[14px]">
        <div className="flex flex-col items-center gap-[50px]">
          ...
          <div>
            <img
              src="/Assets/Skyptop/Skyptopdesign.png"
              alt=""
