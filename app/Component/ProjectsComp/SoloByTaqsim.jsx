...
const styles = {
  ProjectListContainer:
    "w-[75.208vw] my-[90px] flex flex-col gap-[50px] max-lg:w-full ",
  ...
  ProjectListProjectContainer:
    "w-[781px] flex flex-col items-center gap-[24px] max-md:w-full max-lg:w-[76.27vw] max-sm:w-full",
  ...
  ProjectListGridContainerMain:
    "w-[100vw] flex flex-col items-center px-[102px] max-mb:px-[33px] max-xs:px-[14px] mt-[120px] max-md:mt-[50px]",
  ...
  ProjectListGridChild1:
    "w-full bg-[#1A1A1A] rounded-[13.8px] row-span-2 w-[18.47] h-[572px] px-[23px] pt-[23px] max-mb:w-full",
    ...
    <>
      ...
      <div>
          ...
          <div className={styles.ProjectListSecondContainer}>
            <div className={styles.ProjectListSecondContainerInerDiv}>
              <div className={styles.ProjectListSecondContainerInerDivTitleDiv}>
                ...
                <h1 className={styles.ProjectListSecondContainerInerDivTitleDivH1}>
                  SOLO by TAQSIM
                </h1>
              </div>
              <div className={styles.ProjectListSecondContainerInfoDiv}>
                <div>
                  <p className={styles.ProjectListSecondContainerInfoDivTextAlternative}>
                    Virtual instrument
                  </p>
                </div>
                <div>
            ...
            <div className={styles.ProjectListProjectContainer}>
              <div className={styles.ProjectListProjectImage}>
                <img src="/Assets/Solo/solo.png" alt="" />
              </div>
                ...
                <div className={styles.ScopeMainCardMainDiv}>
                  <div className={styles.ScopeMainCardDivLastCart}>
                    <div className={styles.ScopeMainLastCartImg}>
                      <img
                        src="/Assets/futurest-img/figma.png"
                        alt="rocket"
          ...
          <div>
            <div className="flex justify-center items-center gap-[16px] max-ss:flex-col">
              <div className="max-ss:w-full">
                <img src="/Assets/Solo/ui-kit.png" alt="" className="max-ss:w-full" />
              </div>
            </div>
          </div>
        </div>
        <div className="w-[1077px] mt-[120px] max-mb:w-full max-mb:px-[33px] max-ss:px-[23px]">
          ...
          <div className="flex flex-col gap-[16px] justify-center">
            ...
            <div className="flex flex-col items-center gap-[16px]">
              <div>
                <img src="/Assets/Solo/osc1.png" alt="" />
              </div>
              <div>
                <img src="/Assets/Solo/osc2.png" alt="" />
              </div>
              <div>
                <img src="/Assets/Solo/osc3.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        <div className="w-[1077px] mt-[120px] max-mb:w-full max-mb:px-[33px] max-ss:px-[23px]">
          ...
          <div className="flex justify-center items-center gap-[16px] max-ss:flex-col">
            <div className="max-ss:w-full">
              <img src="/Assets/Solo/matrix.png" alt="" className="max-ss:w-full" />
            </div>
            <div className="flex flex-col gap-[16px] max-ss:w-full max-ss:items-center">
              <div className="max-ss:w-full">
                <img src="/Assets/Solo/lfo1.png" alt="" className="max-ss:w-full" />
              </div>
              <div className="max-ss:w-full">
                <img src="/Assets/Solo/lfo2.png" alt="" className="max-ss:w-full" />
              </div>
            </div>
          </div>
        </div>
        <div className="w-[996px] mt-[120px] mb-[90px] max-mb:w-full max-mb:px-[33px] max-ss:px-[23px]">
          ...
          <div>
            <img src="/Assets/Solo/macbook.png" alt="" />
          </div>
        </div>
      </div>
      <Footer />
