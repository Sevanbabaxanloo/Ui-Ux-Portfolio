    ...
    <div className={styles.homeContainer}>
      <div className={styles.homeDivOne}>
        <div className={styles.homeDivOneFirstDiv}>
          <div className={styles.homeDivOneFirstImage}>
            <img src="/Assets/home-image/emoji-blink.png" alt="blinking-emoji" />
          </div>
          <div>
      ...
      <div className={styles.homeDivtwo}>
        <div className={styles.homeDivtwoDivOne}>
          <div className={styles.homeDivSecondDiv}>
            ...
            <div className={styles.homeDivSecondDivImageDiv}>
              <img
                src="/Assets/home-image/emoji-laptop.png"
                alt="emoji-laptop"
        ...
        <div className={styles.homeDivtwoDivTwo}>
          <div className={styles.homeDivtwoDivChild}>
            <a href="https://www.instagram.com/_miriami/?igshid=MzRlODBiNWFlZA%3D%3D" rel="noreferrer" target="_blank">
              <img src="/Assets/social-image/insta-icons.png" alt="social-Istagram" />
            </a>
          </div>
          <div className={styles.homeDivtwoDivChild}>
            <a href="https://t.me/Miriam_ian" rel="noreferrer" target="_blank">
              <img src="/Assets/social-image/tele-icons.png" alt="social-Telegram" />
            </a>
          </div>
          <div className={styles.homeDivtwoDivChild}>
            <a href="https://www.linkedin.com/in/mariam-melqonyan/" rel="noreferrer" target="_blank">
              <img src="/Assets/social-image/linkd-icon.png" alt="social-Linkdin" />
            </a>
          </div>
          <div className={styles.homeDivtwoDivChild}>
            <a href="https://www.behance.net/miriamian" rel="noreferrer" target="_blank">
              <img src="/Assets/social-image/behance-icon.png" alt="social-Behance" />
            </a>
          </div>
        </div>
        <div className={styles.homeDivtwoDivThree}>
          <div className={styles.homeDivtwoDivThreeCountainer}>
            ...
            <div className={styles.homeDivtwoDivThreeImage}>
              <img src="/Assets/home-image/flag.png" alt="Armanian-flag" />
            </div>
          </div>
        </div>
      </div>
      <div className={styles.homeDivThree}>
        <div className={styles.homeDivThreeContainer}>
          <div>
            <img src="/Assets/home-image/emoji-cute.png" alt="emoji-cute" />
          </div>
          <div>
