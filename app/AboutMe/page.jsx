...
const styles = {
  ...
  AboutMeDescriptionDivH2:
    "text-[#FEFFFF] text-[36px] font-[600] max-md:text-[32px] max-md:text-center",
  ...
  AboutMeDescriptionTextContainer:
    "w-[625px] flex flex-row gap-[24px] text-start max-md:flex-col max-md:items-center max-md:w-full",
  AboutMeDescriptionTextP:
    "text-[#525252] text-[18px] font-[500] w-[296px] text-start max-md:text-center max-xs:w-full",
  AboutMeDescriptionTextH2:
    "text-[#FEFFFF] text-[32px] font-[600] w-[304px] max-md:text-center max-xs:w-full",
  ...
  AboutMeSkillBox:
    "flex flex-row flex-wrap justify-between gap-y-[24px] max-mb:justify-center max-mb:gap-x-[28px] max-md:justify-center max-mb:flex-col max-md:items-center max-md:mb-[16px]",
  ...
  AboutMeSkilsImage: "w-[20px] h-[20px] bg-no-repeat max-md:w-[28px] ",
...
const object = [
  {
    image: "/Assets/about-image/about-blink-emoji.png",
    text: "Innovative Thinking",
    skillText: "Problem Solving",
    paragraph: "Innovative problem-solving and impactful solutions for a better experience.",
    skillImage: "/Assets/purple-image/lightpurple.png",
  },
  {
    image: "/Assets/about-image/about-cloud-emoji.png",
    text: "Attention to Detail",
    skillText: "UX Metrics",
    paragraph: "Data-driven insights for improving user engagement and satisfaction.",
    skillImage: "/Assets/purple-image/midpurple.png",
  },
  {
    image: "/Assets/about-image/about-laptop-emoji.png",
    text: "Continuous Improvement",
    skillText: "Visual Hierarchy",
    paragraph: "Compelling visual hierarchy and composition in order to design better.",
    skillImage: "/Assets/purple-image/middarkpurple.png",
  },
  {
    image: "/Assets/about-image/about-confused-emoji.png",
    text: "User-centric Focus",
    skillText: "Design Decisions",
    paragraph: "Leveraging valuable data insights to make informed design decisions.",
    skillImage: "/Assets/purple-image/darkpurple.png",
  },
];
    ...
    <>
      ...
      <div className={styles.AboutMeContainer}>
        <div className={styles.AboutMeDescriptionContainer}>
          ...
          <div className={styles.AboutMeDescriptionImageContainer}>
            <div
              ...
              style={{ backgroundImage: `url(/Assets/home-image/Ellipse.png)` }}
            ></div>
            <div>
            ...
            {object.map((item, index) => (
              <div key={index} className={styles.AboutMeSkillElements}>
                ...
                <div className={styles.AboutMeSkillTextContainer}>
                  <h2 className={styles.AboutMeSkillTextH2}>{item.skillText}</h2>
        ...
        <div className={styles.AboutMeWorkTogetherContainer}>
          <img className="w-[77px]" src="/Assets/home-image/emoji-vi.png" alt="emoji" />
          <h2 className={styles.AboutMeDescriptionDivH2}>
            Wanna work together?
          </h2>
